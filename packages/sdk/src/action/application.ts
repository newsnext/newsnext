...
export const applicationActionContracts = {
  "board.create": boardCreateAction,
  "board.update": boardUpdateAction,
  "board.delete": boardDeleteAction,
  "nowLayer.setManualOrder": nowLayerSetManualOrderAction,
  "nextLayer.installWidget": nextLayerInstallWidgetAction,
  "nextLayer.removeWidget": nextLayerRemoveWidgetAction,
  "nextLayer.setWidgetDataScope": nextLayerSetWidgetDataScopeAction,
  "nextLayer.setWidgetLayouts": nextLayerSetWidgetLayoutsAction,
  "instance.move": instanceMoveAction,
  "instance.create": instanceCreateAction,
  "instance.configure": instanceConfigureAction,
  "instance.resetParams": instanceResetParamsAction,
  "instance.delete": instanceDeleteAction,
  "source.list": sourceListAction,
  "source.get": sourceGetAction,
  "board.list": boardListAction,
  "board.get": boardGetAction,
  "board.listInstances": boardListInstancesAction,
  "instance.list": instanceListAction,
  "instance.get": instanceGetAction,
  "board.getContext": boardGetContextAction,
  "board.getConfiguration": boardGetConfigurationAction,
  "nowLayer.getLiveCards": nowLayerGetLiveCardsAction,
  "application.replace": applicationReplaceAction,
} as const

...
const persons = [
  {
    title: "Ram",
    image: absoluteUrl("/widget/music.jpg"),
  },
  {
    title: "Rick",
  ...
  return (
    ...
    >
          ...
          <button onClick={() => setMinimize(!minimize)}>
            {minimize
              ...
              : (
                  <div className="relative flex">
                    <Square size={14} />
                    <Square className="absolute -bottom-px -left-px" fill="white" size={10} />
                  </div>
                )}
          </button>
      ...
      >
        ...
        <YourImageSlot minimize={minimize} imageAlternate="Your Name" imageSource={absoluteUrl("/widget/music.jpg")} />
      </motion.div>
    </motion.div>
  )
}

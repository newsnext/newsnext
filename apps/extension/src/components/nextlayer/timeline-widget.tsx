...
type MixedItem = ReturnType<typeof mixSourceItems<TimelineSource>>[number]
...
export function TimelineWidget({
  ...
  return (
    <section aria-labelledby={`${gradientId}-title`}>
      <div className="mx-5 mb-4 flex min-w-0 flex-col sm:mx-6">
        <h2 id={`${gradientId}-title`} className="truncate text-base font-bold">
          Timeline
        </h2>

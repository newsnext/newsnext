...
function DraggableLiveCardComponent({ available = true, boardId, descriptor, dragging, instanceAtom, nodeId, sortable = true, readOnly = false }: DraggableLiveCardProps) {

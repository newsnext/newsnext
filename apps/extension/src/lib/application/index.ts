...
export { configureInstanceMutation, createBoardMutation, createInstanceMutation, deleteBoardMutation, deleteInstanceMutation, installNextLayerWidgetMutation, moveInstanceMutation, removeNextLayerWidgetMutation, resetInstanceParamsMutation, setNextLayerWidgetDataScopeMutation, setNextLayerWidgetLayoutsMutation, setNowLayerManualOrderMutation, updateBoardMutation } from "./mutations"

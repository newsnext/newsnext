...
export function FeedEditor({
  ...
  onDraftChange: (key: keyof FeedDraft, value: string | boolean) => void
}) {
  return (
    <Card className="min-w-0">
      ...
      <CardContent className="space-y-4">
        <div className="flex flex-wrap items-center gap-2">
          <FeedStateBadge enabled={draft.enabled} />
          ...
          <TabsContent value="details" className="pt-4">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <EditorField label="Type">
                <select className={selectClassName} value={draft.type} onChange={event => onDraftChange("type", event.target.value as FeedDraft["type"])}>

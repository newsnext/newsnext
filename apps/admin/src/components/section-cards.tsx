...
export function SectionCards({ stats }: { stats: FeedStats }) {
  ...
  return (
    <div className="grid gap-4 px-4 lg:grid-cols-4 lg:px-6">
      <MetricCard title="Total feeds" value={stats.total} description={`${stats.providers} providers`} icon={<Database className="size-4" />} />

...
This open-source repository contains the browser extension and shared Source
packages. The separately distributed NewsNext App, daemon, and CLI are not part
of this repository.

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 6d0f317dee1c803781140dda5df9408a)
// Runtime types generated with workerd@1.20260424.1 2025-12-19 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		BETTER_AUTH_TRUSTED_ORIGINS: "https://newsnext.pro,chrome-extension://cffgbnjiaakknooiegnjkojemhidheke";
		GITHUB_CLIENT_ID: "Ov23lizGxoGltuEXdplC";
		BETTER_AUTH_SECRET: string;
		GITHUB_CLIENT_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		INSTANCE: Fetcher /* newsnext-instance */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEWSNEXT_INSTANCE_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_TRUSTED_ORIGINS" | "GITHUB_CLIENT_ID" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
